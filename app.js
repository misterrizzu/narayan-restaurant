      ...
      <article class="menu-item">
        ...
        <div class="menu-meta">
          ...
          <div class="menu-actions">
            ...
            <a class="btn-wa" href="https://wa.me/${WHATSAPP_NUMBER}?text=I'm interested in ${encodeURIComponent(item.name)} (₹${item.price})" target="_blank" rel="noreferrer" title="Order via WhatsApp">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.67-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.076 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421-7.403h-.004a9.87 9.87 0 00-4.898 1.238l-.36-.182-3.75.964.984-3.595-.235-.374a9.86 9.86 0 011.476-4.529A9.92 9.92 0 0112.7 0C19.337 0 24.67 5.335 24.67 11.975c0 1.71-.33 3.395-.995 4.99l-.237.373 3.639 1.175-.359-1.385a10.014 10.014 0 001.347-5.153c0-5.527-4.495-10.021-10.022-10.021" fill="white"/></svg>
            </a>
          </div>
        </div>
      </article>`
